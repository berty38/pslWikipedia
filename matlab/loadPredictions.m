...
files = {...
    sprintf('%s/caltech-small-left-0.txt', oDir),...
    sprintf('%s/caltech-small-left-1.txt', oDir),...
    sprintf('%s/caltech-small-left-2.txt', oDir),...
    sprintf('%s/caltech-small-left-3.txt', oDir),...
    sprintf('%s/caltech-small-left-4.txt', oDir),...
    sprintf('%s/caltech-small-left-5.txt', oDir),...
    sprintf('%s/caltech-small-left-6.txt', oDir),...
    sprintf('%s/caltech-small-left-7.txt', oDir),...
    sprintf('%s/caltech-small-left-8.txt', oDir),...
    sprintf('%s/caltech-small-left-9.txt', oDir),...
    };
